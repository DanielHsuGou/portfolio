...
const Skill = ({ name, x, y }) => {
  const getIcon = () => {
    switch (name) {
      case "HTML":
        return <FaHtml5 className="w-6 h-6" />;
      case "CSS":
        return <FaCss3Alt className="w-6 h-6" />;
      case "Javascript":
        return <FaJsSquare className="w-6 h-6" />;
      case "ReactJS":
        return <FaReact className="w-6 h-6" />;
      case "NextJS":
        return <SiNextdotjs className="w-6 h-6" />;
      case "Tailwind CSS":
        return <SiTailwindcss className="w-6 h-6" />;
      case "MongoDB":
        return <SiMongodb className="w-6 h-6" />;
      case "Figma":
        return <FaFigma className="w-6 h-6" />;
      case "Github":
        return <FaGitAlt className="w-6 h-6" />;
      case "NodeJS":
        return <FaNodeJs className="w-6 h-6" />;
      case "Express":
        return <SiExpress className="w-6 h-6" />;
      default:
        return null;
    }
  };
  return (
    <motion.div
      className="flex items-center justify-center rounded-full font-semibold bg-dark/80 text-light dark:bg-light/90 dark:text-vdark py-3 px-6 shadow-dark dark:shadow-light cursor-pointer absolute gap-2
...
const Skills = () => {
  return (
    <>
      <h2 className="font-bold text-8xl lg:text-7xl md:text-6xl sm:text-5xl mt-32 w-full text-center">
        Skills
      </h2>
      <div
      ...
      >
        ...
        >
          <TbWorld className="w-14 h-14 md:w-10 md:h-10" />
        </motion.div>
